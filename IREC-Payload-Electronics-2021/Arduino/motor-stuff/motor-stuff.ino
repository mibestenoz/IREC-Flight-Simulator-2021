...
int rpmMaximum = 0;
const int hallSensorPinBlue = 1;  //Hall sensor is connected to these pins.
const int hallSensorPinRed = 2;
const int hallSensorPinGreen = 3;
...
void setup() {
    ...
    pinMode(hallSensorPinBlue, OUTPUT);
    pinMode( hallSensorPinRed, OUTPUT);
    pinMode(hallSensorPinGreen, OUTPUT);
